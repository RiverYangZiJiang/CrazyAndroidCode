...
public class MainActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		DisplayMetrics displayMetrics = new DisplayMetrics();//实例化对象 ，提供了一种关于显示的通用信息，如显示大小，分辨率和字体
		// 获取创建的宽度和高度
		...
		setContentView(line);
		emboss = new EmbossMaskFilter(new float[]     //获取浮雕效果
			{ 1.5f, 1.5f, 1.5f }, 0.6f,	6, 4.2f);
		blur = new BlurMaskFilter(8, BlurMaskFilter.Blur.NORMAL);//设置边缘效果
	}
	@Override
	// 负责创建选项菜单
